...
# @user4 = User.create!(username: 'Paul-Oh', email:'super.paul@email.com', password:'P23456')
...
# @list4 = List.create!(input_1:'thankful that lasagna pans are cheap.', input_2:'thankful that schools teach stranger danger so effectively.', input_3:'alcohol', user: @user4)
...
# @comment3 = Comment.create!(content:'Because of reading this, I am dying less on the inside', user: @user4, list: @list1)
